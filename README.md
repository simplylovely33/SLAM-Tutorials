...
***T_wc***(*world-to-camera*) indicates transform point in the world coordinate system into the camera coordiante system, which is used for **rendering** and **reprojection**.
